PurePlate – Simple Recipe Discovery App
Project Title
...
Data Passing: The app passes specific parameters to ensure the correct nutritional info and ingredients are displayed for the chosen item.
...
lib/screens/ → Contains the three core pages (Home, Discovery, Details).

assets/ → Local images and visual assets for the recipes.

pubspec.yaml → Used to manage dependencies, assets, and app tools.

Features
Clean, responsive UI for various screen sizes.

Functional search and filtering logic.

Detailed recipe cards including nutritional breakdowns.
